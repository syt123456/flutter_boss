...
import 'package:flutter_boss/widgets/question_page.dart';
  ...
  Widget _buildButtonNavBar() {
    return BottomNavigationBar(
      ...
      items: [
        ...
        _buildItem(
            icon: _layoutSelection == LayoutType.question
                ? "images/ic_main_tab_light_pre.png"
                : "images/ic_main_tab_light_nor.png",
            layoutSelection: LayoutType.question),
        _buildItem(
  ...
  void _onSelectTab(int index) {
    switch (index) {
      ...
      case 1:
        ...
        break;
      case 2:
        _onLayoutSelected(LayoutType.question);
        break;
      case 3:
